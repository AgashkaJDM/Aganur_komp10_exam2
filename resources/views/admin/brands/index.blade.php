...
<div class="container-lg my-4">
    ...
    <div>
        <a href="{{ route('admin.brands.create') }}" class="btn btn-success">+ Add new category</a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.brands.edit', $brand->id) }}" class="btn btn-small btn-warning"><i class="bi bi-pencil"></i></a>
